...
class DRNaspp(nn.Module):

    def __init__(self, num_classes=6, dropout_p=0.1):

        super(DRNaspp, self).__init__()

        self.backbone = DRN(BasicBlock, [1, 1, 3, 4, 6, 3, 1, 1], arch='C')
        self.aspp = ASPP(inplanes=512, output_stride=8, dropout=None)
